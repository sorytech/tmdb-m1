...
export class TmdbService {
  ...
  getPopularMovies() {
        return this._http.get<MovieResponse[]>(tmdbApi + '/movie/popular?api_key=384da4d1d38ad08447d757fb4629fa6b&language=en-US&page=1');
    }

  getPopularPerson(){
      return this._http.get<PersonResponse[]>(tmdbApi + '/person/popular?api_key=384da4d1d38ad08447d757fb4629fa6b&language=en-US&page=1');
    }
